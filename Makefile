...
./execution/pipes.c ./execution/builtins.c ./execution/tools.c ./execution/pipe_tools.c ./execution/echo_check.c ./execution/split.c ./execution/readline.c ./execution/stack_init.c ./execution/stack_tools.c ./execution/enogh.c ./execution/export.c ./execution/export_help.c ./execution/unset.c
OBJ = $(SRC:.c=.o)
